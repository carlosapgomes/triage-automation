...
- [ ] 2.1 Ratchet `src/triage_automation/application` for public docstrings and typed public signatures (`tasks/03-ratchet-application.md`)
- [ ] 2.2 Ratchet `src/triage_automation/domain` with same policy and remediation (`tasks/04-ratchet-domain.md`)
