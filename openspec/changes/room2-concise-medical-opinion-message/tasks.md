...
- [ ] 2.1 Exibir `Decisão sugerida` e `Suporte recomendado` exclusivamente a partir de `suggested_action_json` reconciliado.
...
- [ ] 3.1 Atualizar testes unitários de templates Room-2 para validar presença dos sete blocos obrigatórios e ausência do bloco extenso anterior.
