...
Define the shared operational web shell behavior for dashboard and admin pages,
including consistent layout framing, role-aware navigation, and server-side
